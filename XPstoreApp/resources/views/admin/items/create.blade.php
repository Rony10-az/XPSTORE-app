...
<div class="admin-container">
    ...
    <form action="{{ route('admin.items.store') }}" method="POST" enctype="multipart/form-data" class="form-container">
        @csrf
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <select id="rarity" name="rarity" class="form-control" required>
                    ...
                    <option value="común" {{ old('rarity') == 'común' ? 'selected' : '' }}>Común</option>
                    <option value="poco común" {{ old('rarity') == 'poco común' ? 'selected' : '' }}>Poco Común</option>
                    <option value="raro" {{ old('rarity') == 'raro' ? 'selected' : '' }}>Raro</option>
                    <option value="épico" {{ old('rarity') == 'épico' ? 'selected' : '' }}>Épico</option>
